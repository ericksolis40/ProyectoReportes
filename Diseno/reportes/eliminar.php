...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <li class="active"><a href="eliminar.php"><i class=" icon-trash"></i> Baja Reporte</a></li>
...
<td><a href="eliminar1.php?id=<? echo $metodos[$i]['numdiseno']; ?>"><button class="btn btn-mini btn-danger" type="button" >Eliminar <i class="icon-trash"></i></button></a></td>
