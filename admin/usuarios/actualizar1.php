...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <li class="active"><a href="actualizar.php"><i class="icon-pencil icon-black"></i> Modificar</a></li>
...
<div class="span4"></div>
 ...
 <div class="hero-unit">
<form class="form-horizontal" action="actualizar2.php" method="post">
<fieldset>

<!-- Form Name -->
<legend>Modificar Usuario</legend>
<input type="hidden" name="id" value="<? echo $metodos[0]["id_usuarios"];?>" />
...
<div class="control-group">
  ...
  <div class="controls">
        <input id="user" name="user" type="text" placeholder="Ingresa Usuario" class="input-large" required autofocus maxlength="10" value="<? echo $metodos[0]["user"];?>" autocomplete="off">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="pass" name="pass" type="text" placeholder="Ingresa Contrasena" class="input-large" required maxlength="10" value="<? echo $metodos[0]["pass"];?>" autocomplete="off">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="selectbasic" name="tipo"  class="selectpicker input-large">
       <option value="Admin"<?php if ( $metodos[0]["tipos"] == 'Admin') echo ' selected="selected"'; ?> >Administrador</option>
  <option value="Diseno"<?php if ($metodos[0]["tipos"] == 'Diseno') echo ' selected="selected"'; ?> >Diseño</option>
  <option value="Grabados"<?php if ($metodos[0]["tipos"] == 'Grabados') echo ' selected="selected"'; ?> >Grabados</option>
  <option value="Suajes"<?php if ($metodos[0]["tipos"] == 'Suajes') echo ' selected="selected"'; ?> >Suajes</option>
    </select>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="nombre" name="nombre" type="text" placeholder="Ingresa Nombre" class="input-large" required maxlength="30" value="<? echo $metodos[0]["nombre"];?>" autocomplete="off">
  </div>
</div>
