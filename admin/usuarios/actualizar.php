...
for($i = 0;$i < sizeof($metodos);$i++)
{
    ...
    <td><a class="text" href="actualizar1.php?id=<? echo $metodos[$i]["id_usuarios"];?>"><button class="btn btn-mini  btn-info" type="button">Actualizar <i class="icon-pencil"></i></button></a></td>
