...
patron =/[A-Za-z\s\d]/; // Solo acepta letras 
...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <ul class="nav">
      <li  ><a href="../inicio_admin.php"><i class="icon-home icon-black"></i> Inicio</a></li><!---DROPDOWN MENU--->
      <li class="dropdown">
    ...
    <li class="active"><a href="../componentes/colores.php"><i class="icon-wrench icon-black"></i> Colores</a></li>
  </ul>
    </li>
...
<h2 align="center">colores</h2>
<br /><br />
<br />
<!-- Button to trigger modal -->
<div align="center"><a href="#myModal" role="button" class="btn btn-primary" data-toggle="modal">Agregar Color <i class="icon-pencil"></i></a></div>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">Agrega Color</h3>
  </div>
  ...
  <label>Ingresa Nombre</label><br />
    <input type="text" placeholder="Color" name="color" maxlength="20"  onkeypress="return validar(event)" autofocus="autofocus" required autocomplete="off">
...
for($i = 0;$i < sizeof($metodos);$i++)
{
    ...
    <tr align="center">
	<td ><? echo $metodos[$i]["colores"];?></td>
	<td ><a href="eliminar_color.php?id=<? echo $metodos[$i]["id"];?>"><button class="btn btn-mini  btn-danger" type="button">Eliminar <i class="icon-trash"></i></button></a></td>
    </tr>
...
<meta http-equiv="Refresh" content="1; URL= colores.php">
<?
}
